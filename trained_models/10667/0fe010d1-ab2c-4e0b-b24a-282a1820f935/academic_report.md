...
**Generated on:** 2025-11-30 20:45:59  
**Model ID:** `0fe010d1-ab2c-4e0b-b24a-282a1820f935`  
**Model Folder:** `trained_models/10667/0fe010d1-ab2c-4e0b-b24a-282a1820f935`
...
- **R²分数 (R² Score):** 0.855824 (±0.063524)
- **平均绝对误差 (Mean Absolute Error):** 0.282918 (±0.064211)
- **均方误差 (Mean Squared Error):** 0.129130 (±0.053642)
...
| Parameter | Value |
|-----------|-------|
| Data File | `http://47.99.180.80/file/uploads/TS-AF_6.xls` |
...
Continuous Features: SiO2, CeO2, lignin, vinyl
...
|-----------|-----------|-------------|----------------|
| CeO2 | vinyl | -0.3772 | 0.3772 |
| SiO2 | CeO2 | 0.3555 | 0.3555 |
| lignin | vinyl | 0.3094 | 0.3094 |
| SiO2 | lignin | -0.2485 | 0.2485 |
| CeO2 | lignin | -0.2014 | 0.2014 |
| SiO2 | vinyl | -0.1711 | 0.1711 |
...
| CeO2 | vinyl | -0.2787 | 0.2787 |
| lignin | vinyl | 0.2710 | 0.2710 |
| SiO2 | lignin | -0.2525 | 0.2525 |
| SiO2 | vinyl | -0.2024 | 0.2024 |
...
| vinyl | -0.1687 | pearson | 0.1687 | Very Weak |
...
| vinyl | 1.2486 | 0.1991 | Acceptable | ✅ LOW |
...
| vinyl | 4.592 | 2.722 | 0.000 | 9.800 | 9.800 | 4.300 | 0.171 | -0.802 | Yes | 0.0% | 0 |
...
The optimization process completed **10 trials** with the best configuration achieving a cross-validation score of **-0.282918**.
...
- **Learning Rate**: 0.1205712628744377 provides optimal step size for gradient descent
- **Regularization**: L1=3.33e-08, L2=6.25e-01 prevent overfitting
- **Sampling**: 0.8394633936788146 row sampling and 0.6624074561769746 column sampling for robustness
...
|--------|------------|-----|-----|
| MAE | 0.282918 ± 0.064211 | 0.190093 | 0.377316 |
| MSE | 0.129130 ± 0.053642 | 0.051810 | 0.205334 |
| R2 | 0.855824 ± 0.063524 | 0.768666 | 0.922748 |
...
| Fold | MAE | MSE | R2 |
|------|---------|---------|---------|
| 1 | 0.190093 | 0.051810 | 0.922720 |
| 2 | 0.327752 | 0.205334 | 0.768666 |
| 3 | 0.260148 | 0.104009 | 0.922748 |
| 4 | 0.377316 | 0.170770 | 0.796874 |
| 5 | 0.259278 | 0.113727 | 0.868110 |

#### Statistical Summary

| Metric | Mean | Std Dev | Min | Max | 95% CI |
|--------|------|---------|-----|-----|--------|
| MAE | 0.282918 | 0.064211 | 0.190093 | 0.377316 | [0.226635, 0.339201] |
| MSE | 0.129130 | 0.053642 | 0.051810 | 0.205334 | [0.082110, 0.176150] |
| R2 | 0.855824 | 0.063524 | 0.768666 | 0.922748 | [0.800142, 0.911505] |
...
|------|---------|------|--------|-------|--------|----------|
| 1 | `SiO2` | 2.0039 | 65 | 31.37 | 58.2% | 28.8% |
| 2 | `lignin` | 0.8428 | 48 | 33.79 | 24.5% | 21.2% |
| 3 | `vinyl` | 0.4005 | 44 | 33.86 | 11.6% | 19.5% |
| 4 | `CeO2` | 0.1960 | 69 | 31.57 | 5.7% | 30.5% |
...
|------|---------|-----------------|---------|--------|-------------|
| 1 | `SiO2` | 1.1811 | 0.1193 | [0.9472, 1.4150] | 🟡 Medium |
| 2 | `lignin` | 0.1614 | 0.0229 | [0.1165, 0.2064] | 🟡 Medium |
| 3 | `vinyl` | 0.0305 | 0.0050 | [0.0208, 0.0402] | 🟡 Medium |
| 4 | `CeO2` | 0.0245 | 0.0088 | [0.0072, 0.0419] | 🔴 Low |
...
- **Gain-based Top Feature**: `SiO2` (Gain: 2.0039)
- **Permutation-based Top Feature**: `SiO2` (Importance: 1.1811)

**Method Reliability Assessment:**
- **Average Permutation Std**: 0.0390
...
- **Cross-Validation Data**: `trained_models/10667/0fe010d1-ab2c-4e0b-b24a-282a1820f935/cross_validation_data/`
- **Feature Importance**: `trained_models/10667/0fe010d1-ab2c-4e0b-b24a-282a1820f935/feature_importance.csv`
...
- **Generation Time**: 2025-11-30 20:45:59
- **Model ID**: `0fe010d1-ab2c-4e0b-b24a-282a1820f935`
...
```
0fe010d1-ab2c-4e0b-b24a-282a1820f935/
├── model.joblib
...
│   ├── 0fe010d1-ab2c-4e0b-b24a-282a1820f935_cv_predictions_original.csv
│   ├── 0fe010d1-ab2c-4e0b-b24a-282a1820f935_cv_predictions_processed.csv
│   ├── 0fe010d1-ab2c-4e0b-b24a-282a1820f935_cv_scatter_plot.png
│   ├── 0fe010d1-ab2c-4e0b-b24a-282a1820f935_original_data.csv
│   ├── 0fe010d1-ab2c-4e0b-b24a-282a1820f935_preprocessed_data.csv
