            ...
            if generate_report:
                try:
                    ...
                    try:
                        ...
                        results['predicttion_report_summary_html_path'] = f"result only show the first 10 predictions, You can find the html prediction report summary in {html_relative_path}"
                    except ValueError:
                        # Fallback if relative path calculation fails
                        results['predicttion_report_summary_html_path'] = f"You can find the html prediction report summary in {get_static_url(html_report_path)}"
                    ...
                    if prediction_folder:
                        ...
                        if prediction_archive_path:
                            ...
                            which can be downloaded by users for reproducibility and academic research reference.  """
                                ...
                                folder_relative_path = get_download_url(prediction_folder) # type: ignore
                                results['prediction_details'] = f"""All detailed prediction data are saved in {folder_relative_path},
                            which can be downloaded by users for reproducibility and academic research reference.  """ # type: ignore
                ...
                if prediction_folder:
                    ...
                    if prediction_archive_path:
                        ...
                        which can be downloaded by users for reproducibility and academic research reference.  """
                            ...
                            folder_relative_path = get_download_url(prediction_folder) # type: ignore
                            results['prediction_details'] = f"""All detailed prediction data are saved in {get_download_url(folder_relative_path)},
                        which can be downloaded by users for reproducibility and academic research reference.  """
